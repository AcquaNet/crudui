...
public abstract class AbstractAutoGeneratedCrudFormFactory<T> extends AbstractCrudFormFactory<T> {
	...
	protected String cancelButtonCaption = "Cancelar";
	protected String validationErrorMessage = "Por favor corrija el error y pruebe nuevamente.";
	...
	public AbstractAutoGeneratedCrudFormFactory(Class<T> domainType) {
		...
		setButtonCaption(CrudOperation.READ, "Confirmar");
		setButtonCaption(CrudOperation.ADD, "Agregar");
		setButtonCaption(CrudOperation.UPDATE, "Actualizar");
		setButtonCaption(CrudOperation.DELETE, "Si, eliminar");
	...
	protected void bindField(HasValue field, String property, Class<?> propertyType,
		...
		if (configuration.getConverters().containsKey(property)) {
			...
			bindingBuilder = bindingBuilder.withConverter(new StringToDoubleConverter(null, "Debe ser un número"));

		} else if (Long.class.isAssignableFrom(propertyType) || long.class.isAssignableFrom(propertyType)) {
			bindingBuilder = bindingBuilder.withConverter(new StringToLongConverter(null, "Debe ser un número"));

		} else if (BigDecimal.class.isAssignableFrom(propertyType)) {
			bindingBuilder = bindingBuilder.withConverter(new StringToBigDecimalConverter(null, "Debe ser un número"));

		} else if (BigInteger.class.isAssignableFrom(propertyType)) {
			bindingBuilder = bindingBuilder.withConverter(new StringToBigIntegerConverter(null, "Debe ser un número"));

		} else if (Integer.class.isAssignableFrom(propertyType) || int.class.isAssignableFrom(propertyType)) {
			bindingBuilder = bindingBuilder.withConverter(new StringToIntegerConverter(null, "Debe ser un número"));

		} else if (Byte.class.isAssignableFrom(propertyType) || byte.class.isAssignableFrom(propertyType)) {
			bindingBuilder = bindingBuilder.withConverter(new StringToByteConverter(null, "Debe ser un número"));
			...
			bindingBuilder = bindingBuilder.withConverter(new StringToFloatConverter(null, "Debe ser un número"));
